/**
 * Accounting Services - Application Layer Export
 *
...
/**
 * Accounting Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for accounting domain.
 */
