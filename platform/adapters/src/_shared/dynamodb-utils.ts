 ...
 *
 * @returns The core table name (e.g., "hopsettle-core-dev")
 ...
 *
 * @returns The base table name (e.g., "hopsettle-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "hopsettle-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "hopsettle-app-realtime-dev")
