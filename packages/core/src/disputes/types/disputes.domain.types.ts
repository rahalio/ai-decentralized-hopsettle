...
export type DisputeEvidenceExport = components["schemas"]["DisputeEvidenceExport"];
...
export type EvidenceExport = operations["exportDisputeEvidence"]["responses"]["200"]["content"]["application/json"]["data"];
...
export type CreateDisputeRequestInput = NonNullable<operations["createDispute"]["requestBody"]>["content"]["application/json"];
...
export type GetDisputeParams = operations["getDispute"]["parameters"]["path"];
export type ExportDisputeEvidenceParams = operations["exportDisputeEvidence"]["parameters"]["path"];
...
export type CreateDisputeResponse = operations["createDispute"]["responses"]["201"]["content"]["application/json"];
export type GetDisputeResponse = operations["getDispute"]["responses"]["200"]["content"]["application/json"];
export type ExportDisputeEvidenceResponse = operations["exportDisputeEvidence"]["responses"]["200"]["content"]["application/json"];
